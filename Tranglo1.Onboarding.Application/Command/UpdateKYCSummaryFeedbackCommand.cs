...
namespace Tranglo1.Onboarding.Application.Command
{
    ...
    internal class UpdateKYCSummaryFeedbackCommand : BaseCommand<Result<KYCSummaryFeedbackOutputDTO>>
    {
        ...
        public override Task<string> GetAuditLogAsync(Result<KYCSummaryFeedbackOutputDTO> result)
        {
            if (result.IsSuccess)
            {
                string _description = $"Edit User's KYC Details";
        ...
        public class UpdateKYCSummaryFeedbackCommandHandler : IRequestHandler<UpdateKYCSummaryFeedbackCommand, Result<KYCSummaryFeedbackOutputDTO>>
        {
            private readonly BusinessProfileService _businessProfileService;
            private readonly ILogger<UpdateKYCSummaryFeedbackCommandHandler> _logger;
            public IUnitOfWork UnitOfWork { get; }

            public UpdateKYCSummaryFeedbackCommandHandler(
                    BusinessProfileService businessProfileService,
                    ILogger<UpdateKYCSummaryFeedbackCommandHandler> logger,
            ...
            public async Task<Result<KYCSummaryFeedbackOutputDTO>> Handle(UpdateKYCSummaryFeedbackCommand request, CancellationToken cancellationToken)
            {
                ...
                else
                {
                    ...
                    return Result.Failure<KYCSummaryFeedbackOutputDTO>(
                            $"Unable to update KYC Summary Feedback for {request.BusinessProfileCode}. Check failed"
                        );
                }
