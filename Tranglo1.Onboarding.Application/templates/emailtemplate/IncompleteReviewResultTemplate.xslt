	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Your business KYC <xsl:value-of select="Solution"/> details have been compliance reviewed.There are feedbacks
					from Tranglo's Compliance team which requires your attention. 
				</p>
				<p>
					<br></br>
					Please login to view and proceed with amendments.	
				</p>
				<br></br>
				<b>
					<xsl:element name="a">
				...
				<p>
					...
					<xsl:element name="a">
						<xsl:attribute name="href">
							<xsl:value-of select="email1Url"/>
						</xsl:attribute>
					<xsl:value-of select="Email1"/>
					</xsl:element>  or 
					<xsl:element name="a">
						<xsl:attribute name="href">
							<xsl:value-of select="email2Url"/>
						</xsl:attribute>
					<xsl:value-of select="Email2"/>
					</xsl:element>  if you need any further assistance.
				</p>
				<br></br>
				<br></br>
				<p>Thank you.</p>
