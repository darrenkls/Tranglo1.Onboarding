	...
	<xsl:template match="BusinessPartner">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				We are pleased to inform you that your onboarding process is completed, and your account is now live.
				<br></br>
				<br></br>
				You can now proceed to log in and access the Tranglo Business by clicking on the button below:
				<br></br>
				<br></br>
				<br></br>
				<b>
				...
				<br></br>
				<p>
					If you require any further assistance, please do not hesitate to reach out to us at <a href="mailto:partnerships@tranglo.com">partnerships@tranglo.com</a>.
				</p>
				<br></br>
				<p>Thank you.</p>
				<br></br> 
