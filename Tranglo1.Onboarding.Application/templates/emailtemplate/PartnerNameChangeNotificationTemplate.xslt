	...
	<xsl:template match="BusinessPartner">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<p>
				<br></br>
				Kindly note that <xsl:value-of select="existingCompanyRegisteredName"/> has changed its name to  <xsl:value-of select="currentRegisteredCompanyName"/> in  <xsl:value-of select="SolutionName"/>.
				<br></br>
				Please log into the portal to take the necessary action.
				</p>
				<br></br>
				<br></br>
				<p>Thank you.</p>
