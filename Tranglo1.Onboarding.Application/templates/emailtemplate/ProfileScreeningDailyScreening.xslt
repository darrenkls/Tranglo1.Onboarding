		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<xsl:if test="IsSanctionDetected = 'True'">
					<p>
						Below are the daily screening results of the KYC profiles to be reviewed via <a href="{PersonnelWatchlistUrl}">T1 portal</a>.
					</p>
					<p>
						Screening Date: <b><xsl:value-of select="ScreeningDate"/></b>
					</p>
				...
				<xsl:if test="IsSanctionDetected = 'False'">
					<p>
						The screening for all existing partners has been completed, and there are <b>no new screening hits</b> identified.
					</p>
					<p>
						Screening Date: <b><xsl:value-of select="ScreeningDate"/></b>
					</p>
