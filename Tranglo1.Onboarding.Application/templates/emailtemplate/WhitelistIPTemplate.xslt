...
>
	<xsl:template match="WhitelistIPTemplate">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<p>
				...
				<br></br>
				<p>
					Your IP address has been successfully whitelisted at our end. Kindly test the connection.
				</p>
				<br></br>
				...
				<br></br>
				Staging IP address: <xsl:value-of select="StagingIPAddress"/>
				<br></br>
				Production IP address: <xsl:value-of select="ProductionIPAddress"/>
				<br></br>
				<br></br>
				Thank You.
