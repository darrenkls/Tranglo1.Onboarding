...
>
	<xsl:template match="CallbackURLSubmittedTemplate">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<p>
					There's a callback URL configuration request from <xsl:value-of select="PartnerName"/>
				</p>
				<br></br>
				...
				<br></br>
					...
					You may login to admin portal to check partner information. Kindly click the Configuration Done button after you have configured the callback URL and an email notification will be sent to the partner.
