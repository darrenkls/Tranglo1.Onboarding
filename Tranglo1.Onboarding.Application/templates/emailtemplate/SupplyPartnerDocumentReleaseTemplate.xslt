...
>
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<p>
					Dear Valued <xsl:value-of select="FullName"/>,
				</p>
				<br></br>
				<p>
					Good day to you! Kindly refer to the attached documents requested in this email for your perusal.
				</p>
				<p>
