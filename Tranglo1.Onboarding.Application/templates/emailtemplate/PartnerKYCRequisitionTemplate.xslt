	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					<xsl:value-of select="PartnerName"/> has been categorized as higher risk KYC and higher 
					approval is required to proceed with the onboarding process.
				</p>
				<p>
					<br></br>
					You may login to carry out the review and perform requisition approval.
				</p>
				<br></br>
				<b>
					<xsl:element name="a">
