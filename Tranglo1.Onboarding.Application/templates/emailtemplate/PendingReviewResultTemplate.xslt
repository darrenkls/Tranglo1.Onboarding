	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Company  <xsl:value-of select="Name"/> has been categorised as higher risk KYC.
					Approval on <xsl:value-of select="Solution"/> KYC is required from Head of Compliance to proceed with the onboarding
					process.
				</p>
				<p>
					<br></br>
