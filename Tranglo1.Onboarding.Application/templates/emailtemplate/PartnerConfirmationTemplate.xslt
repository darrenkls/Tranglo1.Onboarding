...
>
	<xsl:template match="PartnerConfirmationTemplate">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					<xsl:value-of select="PartnerName"/> has confirmed that Tranglo's IP address is already whitelisted on their end. Kindly proceed with the next course of action.
				</p>
				<br></br>
				<p>
					You may login to admin portal to check partner information.
				</p>
				<br></br>
				<b>
					<xsl:element name="a">
