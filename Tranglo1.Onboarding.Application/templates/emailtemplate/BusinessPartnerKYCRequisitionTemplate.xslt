	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Company <xsl:value-of select="PartnerName"/> has been categorized as higher risk KYC.
					Approval on (Tranglo Business) KYC is required from <xsl:value-of select="FullName"/> to proceed with the onboarding process.
				</p>
				<p>
					<br></br>
