	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					As part of the KYC process, Tranglo's Compliance has release these
					Tranglo's KYC documents <xsl:value-of select="Solution"/> for your review.
				</p>
				<p>
					<br></br>
					You may login to track your business KYC review progress.
				</p>
				<br></br>
				<b>
						<xsl:element name="a">
				...
				<p>
					...
					<xsl:element name="a">
						<xsl:attribute name="href">
							<xsl:value-of select="emailUrl"/>
						</xsl:attribute>
					<xsl:value-of select="Email"/>
					</xsl:element> if you need any further information.
				</p>
				<br></br>
				<p>Thank you.</p>
				<br></br>
