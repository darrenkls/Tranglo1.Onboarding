	...
	<xsl:template match="Subscription">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Below subscription(s) have been added for <span style="color:Green">
					...
					<table>
						<xsl:for-each select="Subscriptions">
							...
							<tr>
								...
								<td>:</td>
								<td>
									<xsl:value-of select="PartnerType"/>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td style=" height: 20px !important;" colspan="3"></td>
							</tr>
						</xsl:for-each>
					</table>
					<br></br>
				...
				<p>
					You may manage partner within the portal.
