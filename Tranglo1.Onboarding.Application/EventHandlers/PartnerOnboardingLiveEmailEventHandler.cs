...
{
     class PartnerOnboardingLiveEmailEventHandler : BaseEventHandler<PartnerOnboardingEmailLiveEmailEvent>
    {

        private readonly ILogger<PartnerOnboardingLiveEmailEventHandler> _logger;
        ...
        public PartnerOnboardingLiveEmailEventHandler(
            ILogger<PartnerOnboardingLiveEmailEventHandler> logger,
        ...
        protected override async Task HandleAsync(PartnerOnboardingEmailLiveEmailEvent @event, CancellationToken cancellationToken)
        {
            ...
            var partnerSubs = await _partnerRepository.GetSubscriptionAsync(@event.PartnerSubscriptionCode);
