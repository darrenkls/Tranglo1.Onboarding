...
using Tranglo1.ApprovalWorkflowEngine.EntityFramework.Options;
...
{
    public class KYCPartnerStatusRequisitionDbContext : BaseDbContext, IApprovalWorkflowManagerDbContext<PartnerKYCStatusRequisition> 
    {
        public KYCPartnerStatusRequisitionDbContext(
            DbContextOptions<KYCPartnerStatusRequisitionDbContext> options, IEventDispatcher dispatcher,
        ...
        public DbSet<PartnerKYCStatusRequisition> RequisitionDetails { get ; set ; }
        public DbSet<ApprovalHistory<PartnerKYCStatusRequisition>> ApprovalHistories { get; set; }
